...
/**
 * StoreModelAPI interface representing StoreModel API for external entities
 * such as StoreModelController
 *
...
public interface StoreModelAPI {
         ...
         * @throws StoreModelException
         */
        public Basket removeBasketProduct(Long basketId, Long productId, int count, String token)
                        throws StoreModelException;
